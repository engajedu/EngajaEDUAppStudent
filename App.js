...
import IntermediatePositionScreen from './src/screens/IntermediatePositionScreen';
    ...
    <ThemeProvider>
      ...
      <NavigationContainer>
        <Stack.Navigator initialRouteName='Initial' screenOptions={{
          ...
          <Stack.Screen name='IntermediatePosition' component={IntermediatePositionScreen} />
        </Stack.Navigator>
      </NavigationContainer>
